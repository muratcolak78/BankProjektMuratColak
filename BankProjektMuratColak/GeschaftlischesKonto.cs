...
{
    internal class GeschaftlischesKonto : IKonto
    {
        ...
        private double MonatlicheKontoFührungsBebühr = 5;
        private double Überweisungsgebühr = 5;
        private double maxLimit = 100000;
        ...
        public GeschaftlischesKonto(Kontoinhaber haber, string hesapAdi)
        {
            Inhaber = haber;
        ...
        {
            return $"Geschäftskonto \t:{Kontoname1}\t\t{Saldo1}\t\t{maxLimit}";
        }
