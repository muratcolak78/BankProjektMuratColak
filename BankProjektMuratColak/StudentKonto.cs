...
{
    internal class StudentKonto : IKonto
    {
        ...
        private double MonatlicheZinsen = 0.1;
        private double MonatlicheKontoFührungsBebühr = 0;
        private double Überweisungsgebühr = 0;
        private double maxLimit = 2000;
        ...
        public StudentKonto(Kontoinhaber haber, string hesapAdi)
        {
            Inhaber = haber;
        ...
        {
            return $"Studentenkonto \t:{Kontoname1}\t\t{Saldo1}\t\t{maxLimit}";
        }
